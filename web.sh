...
su - $SUDO_USER -c "scp ${SCRIPT_DIR}/backup.sh ${REMOTE_USER}@${DB_REPLICA}:/tmp/"
...
su - $SUDO_USER -c "test -f ${SCRIPT_DIR}/soft/grafana_11.2.2_amd64.deb && scp ${SCRIPT_DIR}/soft/grafana_11.2.2_amd64.deb ${REMOTE_USER}@${ELK}:/tmp/"
su - $SUDO_USER -c "test -f ${SCRIPT_DIR}/soft/elasticsearch_8.17.1_amd64.deb && scp ${SCRIPT_DIR}/soft/elasticsearch_8.17.1_amd64.deb ${REMOTE_USER}@${ELK}:/tmp/"
su - $SUDO_USER -c "test -f ${SCRIPT_DIR}/soft/kibana_8.17.1_amd64.deb && scp ${SCRIPT_DIR}/soft/kibana_8.17.1_amd64.deb ${REMOTE_USER}@${ELK}:/tmp/"
su - $SUDO_USER -c "test -f ${SCRIPT_DIR}/soft/logstash_8.17.1_amd64.deb && scp ${SCRIPT_DIR}/soft/logstash_8.17.1_amd64.deb ${REMOTE_USER}@${ELK}:/tmp/"
